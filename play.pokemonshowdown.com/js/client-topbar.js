(function ($) {
	...
	this.Topbar = Backbone.View.extend({
		...
		initialize: function () {
			...
			this.$el.html('<img class="logo" src="logo.png" alt="Yugioh Duel" width="146" height="44" style="mix-blend-mode: multiply"; /><div class="maintabbarbottom"></div><div class="tabbar maintabbar"><div class="inner"></div></div><div class="userbar"></div>');
