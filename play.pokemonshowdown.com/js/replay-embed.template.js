...
linkStyle('https://play.yugiohduel.net/style/font-awesome.css?');
linkStyle('https://play.yugiohduel.net/style/battle.css?a7');
linkStyle('https://play.yugiohduel.net/style/replay.css?a7');
linkStyle('https://play.yugiohduel.net/style/utilichart.css?a7');

requireScript('https://play.yugiohduel.net/js/lib/ps-polyfill.js');
requireScript('https://play.yugiohduel.net/config/config.js?a7');
requireScript('https://play.yugiohduel.net/js/lib/jquery-1.11.0.min.js');
requireScript('https://play.yugiohduel.net/js/lib/html-sanitizer-minified.js');
requireScript('https://play.yugiohduel.net/js/battle-sound.js');
requireScript('https://play.yugiohduel.net/js/battledata.js?a7');
requireScript('https://sim.yugiohduel.net/data/pokedex-mini.js?a7');
requireScript('https://sim.yugiohduel.net/data/pokedex-mini-bw.js?a7');
requireScript('https://sim.yugiohduel.net/data/graphics.js?a7');
requireScript('https://sim.yugiohduel.net/data/pokedex.js?a7');
requireScript('https://sim.yugiohduel.net/data/moves.js?a7');
requireScript('https://sim.yugiohduel.net/data/abilities.js?a7');
requireScript('https://sim.yugiohduel.net/data/items.js?a7');
requireScript('https://sim.yugiohduel.net/data/teambuilder-tables.js?a7');
requireScript('https://play.yugiohduel.net/js/battle-tooltips.js?a7');
requireScript('https://play.yugiohduel.net/js/battle.js?a7');
